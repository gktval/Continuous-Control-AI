...
class Critic(nn.Module):
    ...
    def __init__(self, state_size, action_size, fc1_units=128, fc2_units=256, fc3_units = 128, fc4_units = 32):
...
class CriticDist(nn.Module):
    ...
    def __init__(self, state_size, action_size, v_min, v_max, num_atoms, 
                fc1_units=128, fc2_units=256, fc3_units = 128, fc4_units = 32):
...
class FullyConnectedNetwork(nn.Module):
    ...
    def __init__(self, state_size, action_size, fc1_units=128, fc2_units=64, output_gate=None):
        super(FullyConnectedNetwork, self).__init__()
        self.linear1 = nn.Linear(state_size, fc1_units)
